 ...
 * ©2015-2015 Diogo Sant'Ana - MIT Licensed
 */
...
function _numbers ( page, pages ) {
	...
	if ( pages <= buttons ) {
		...
		numbers.splice( 0, 0, 'goto' ); // no unshift in ie6
...
$.extend(extPagination, {
	goto_simple_numbers: function ( page, pages ) {
		...
		for ( i=0, ien=buttons.length ; i<ien ; i++ ) {
			...
			if ( $.isArray( button ) ) {
				...
				if ( btnDisplay ) {
					...
					if (button === 'goto') {
						anchor.empty().append( $('<input>', {
								'id': settings.sTableId + '_goto_page_input',
								'placeholder': '...',
								'data-dt-idx': 'goto'
							} ).css({
									width: '35px',
